...
public class FrameUlepszenia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Power Pack 1 (100€)");

        jLabel5.setText("Moc");

        jLabel6.setText("Ładowność");

        jProgressBar1.setToolTipText("");
        jProgressBar1.setValue(Ulepszenia.u.GetMoc());

        jProgressBar2.setValue(Ulepszenia.u.GetCapacity());

        jLabel7.setText("Capacity Pack 1 (120€)");
