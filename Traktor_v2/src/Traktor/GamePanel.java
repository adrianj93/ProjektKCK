...
//                            dlm.addElement("Czy zaorać to pole?");
                            ...
                            PlowObject op = new PlowObject();
                            board.SetObject(pAgent.x, pAgent.y, false, op);
                    ...
                    {   
                        ...
                        if(isWater)
                        {
                            CollectingObject op = new CollectingObject();
                            board.SetObject(pAgent.x, pAgent.y, false, op);
                        }
                        else
                        {
                    ...
                    {   
                        ...
                        if(isSow)
                        {
                            WaterObject op = new WaterObject();
                            board.SetObject(pAgent.x, pAgent.y, false, op);
                        }
                        else
                        {
