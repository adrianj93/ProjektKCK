...
public class Informations {
    ...
    public static String ExistStore = "Nie możesz przejść na to pole, jest zajęte przez hangar!";
    public static String UnknownCommand = "Nie rozumiem polecenia. Wydaj inne";
    public static String Obstacle = "Nie możesz przejść na to pole, jest zajęte przez przeszkode Usuń ją.";
}
